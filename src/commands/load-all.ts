...
export const commands: Commands = function () {
  ...
  const commands = {
    ...
    "dance.match.surround": new CommandDescriptor(
      ...
      (_, argument) => _.runAsync(async (_) => await match_surround(_, _.selections, getRegister(_, argument, "dquote", Register.Flags.CanRead), getInputOr("input", argument))),
      CommandDescriptor.Flags.RequiresActiveEditor,
    ),
    "dance.match.surrounddelete": new CommandDescriptor(
      "dance.match.surrounddelete",
      (_, argument) => _.runAsync(async (_) => await match_surrounddelete(_, getInputOr("input", argument))),
      CommandDescriptor.Flags.RequiresActiveEditor,
    ),
    "dance.match.surroundreplace": new CommandDescriptor(
      "dance.match.surroundreplace",
      (_, argument) => _.runAsync(async (_) => await match_surroundreplace(_, _.selections, getInputOr("input", argument))),
      CommandDescriptor.Flags.RequiresActiveEditor,
    ),
    ...
    "dance.seek.selectExpand": new CommandDescriptor(
      ...
      (_) => _.runAsync(async (_) => await seek_selectExpand()),
      CommandDescriptor.Flags.None,
    ),
    "dance.seek.selectShrink": new CommandDescriptor(
      "dance.seek.selectShrink",
      (_) => _.runAsync(async (_) => await seek_selectShrink()),
      CommandDescriptor.Flags.None,
    ),
