...
<tr><td><a href="../edit.ts#L415"><code>edit.newLine.above.insert</code></a></td><td>Insert new line above and switch to insert</td><td><code>Shift+O</code> (<code>editorTextFocus && dance.mode == 'normal'</code>)<code>Shift+O</code> (<code>editorTextFocus && dance.mode == 'select'</code>)</td></tr>
<tr><td><a href="../edit.ts#L453"><code>edit.newLine.below.insert</code></a></td><td>Insert new line below and switch to insert</td><td><code>O</code> (<code>editorTextFocus && dance.mode == 'normal'</code>)<code>O</code> (<code>editorTextFocus && dance.mode == 'select'</code>)</td></tr>
...
<tr><td rowspan=2><a href="#keybindings"><code>keybindings</code></a></td><td><a href="#keybindings.addCommand"><code>keybindings.addCommand</code></a></td><td>Add a command to the command menu</td><td></td></tr>
<tr><td><a href="#keybindings.setup"><code>keybindings.setup</code></a></td><td>Set up Dance keybindings</td><td></td></tr>
...
<tr><td><a href="#selectRegister"><code>selectRegister</code></a></td><td>Select register for next command</td><td><code>Shift+'</code> (<code>editorTextFocus && dance.mode == 'normal'</code>)<code>Shift+'</code> (<code>editorTextFocus && dance.mode == 'select'</code>)</td></tr>
...
<tr><td><a href="#seek.goto.syntax.object"><code>seek.goto.syntax.object</code></a></td><td>Goto next object in direction</td><td></td></tr>
<tr><td><a href="#seek.jumpLabel"><code>seek.jumpLabel</code></a></td><td>Jump to label</td><td></td></tr>
...
<tr><td><a href="../seek.ts#L602"><code>seek.askObject</code></a></td><td>Select whole object</td><td><code>Alt+A</code> (<code>editorTextFocus && dance.mode == 'normal'</code>)<code>Alt+A</code> (<code>editorTextFocus && dance.mode == 'insert'</code>)</td></tr>
<tr><td><a href="../seek.ts#L608"><code>seek.askObject.end</code></a></td><td>Select to whole object end</td><td><code>]</code> (<code>editorTextFocus && dance.mode == 'normal'</code>)</td></tr>
<tr><td><a href="../seek.ts#L609"><code>seek.askObject.end.extend</code></a></td><td>Extend to whole object end</td><td><code>Shift+]</code> (<code>editorTextFocus && dance.mode == 'normal'</code>)</td></tr>
<tr><td><a href="../seek.ts#L603"><code>seek.askObject.inner</code></a></td><td>Select inner object</td><td><code>Alt+I</code> (<code>editorTextFocus && dance.mode == 'normal'</code>)<code>Alt+I</code> (<code>editorTextFocus && dance.mode == 'insert'</code>)</td></tr>
<tr><td><a href="../seek.ts#L610"><code>seek.askObject.inner.end</code></a></td><td>Select to inner object end</td><td><code>Alt+]</code> (<code>editorTextFocus && dance.mode == 'normal'</code>)</td></tr>
<tr><td><a href="../seek.ts#L611"><code>seek.askObject.inner.end.extend</code></a></td><td>Extend to inner object end</td><td><code>Shift+Alt+]</code> (<code>editorTextFocus && dance.mode == 'normal'</code>)</td></tr>
<tr><td><a href="../seek.ts#L606"><code>seek.askObject.inner.start</code></a></td><td>Select to inner object start</td><td><code>Alt+[</code> (<code>editorTextFocus && dance.mode == 'normal'</code>)</td></tr>
<tr><td><a href="../seek.ts#L607"><code>seek.askObject.inner.start.extend</code></a></td><td>Extend to inner object start</td><td><code>Shift+Alt+[</code> (<code>editorTextFocus && dance.mode == 'normal'</code>)</td></tr>
<tr><td><a href="../seek.ts#L604"><code>seek.askObject.start</code></a></td><td>Select to whole object start</td><td><code>[</code> (<code>editorTextFocus && dance.mode == 'normal'</code>)</td></tr>
<tr><td><a href="../seek.ts#L605"><code>seek.askObject.start.extend</code></a></td><td>Extend to whole object start</td><td><code>Shift+[</code> (<code>editorTextFocus && dance.mode == 'normal'</code>)</td></tr>
...
<tr><td><a href="../seek.ts#L820"><code>seek.leap.backward</code></a></td><td>Leap backward</td><td></td></tr>
<tr><td><a href="../seek.ts#L681"><code>seek.syntax.child.experimental</code></a></td><td>Select child syntax object</td><td><code>Alt+I</code> (<code>editorTextFocus && dance.mode == 'normal'</code>)<code>Alt+I</code> (<code>editorTextFocus && dance.mode == 'select'</code>)<code>Alt+Down</code> (<code>editorTextFocus && dance.mode == 'normal'</code>)<code>Alt+Down</code> (<code>editorTextFocus && dance.mode == 'select'</code>)</td></tr>
<tr><td><a href="../seek.ts#L678"><code>seek.syntax.next.experimental</code></a></td><td>Select next syntax object</td><td><code>Alt+N</code> (<code>editorTextFocus && dance.mode == 'normal'</code>)<code>Alt+N</code> (<code>editorTextFocus && dance.mode == 'select'</code>)</td></tr>
<tr><td><a href="../seek.ts#L680"><code>seek.syntax.parent.experimental</code></a></td><td>Select parent syntax object</td><td><code>Alt+O</code> (<code>editorTextFocus && dance.mode == 'normal'</code>)<code>Alt+O</code> (<code>editorTextFocus && dance.mode == 'select'</code>)<code>Alt+Up</code> (<code>editorTextFocus && dance.mode == 'normal'</code>)<code>Alt+Up</code> (<code>editorTextFocus && dance.mode == 'select'</code>)</td></tr>
<tr><td><a href="../seek.ts#L679"><code>seek.syntax.previous.experimental</code></a></td><td>Select previous syntax object</td><td><code>Alt+P</code> (<code>editorTextFocus && dance.mode == 'normal'</code>)<code>Alt+P</code> (<code>editorTextFocus && dance.mode == 'select'</code>)</td></tr>
...
<tr><td rowspan=42><a href="#select"><code>select</code></a></td><td><a href="#select.buffer"><code>select.buffer</code></a></td><td>Select whole buffer</td><td><code>Shift+5</code> (<code>editorTextFocus && dance.mode == 'normal'</code>)<code>Shift+5</code> (<code>editorTextFocus && dance.mode == 'select'</code>)</td></tr>
...
### [`edit.join.select`](../edit.ts#L150-L155)
...
### [`edit.indent.withEmpty`](../edit.ts#L171-L176)
...
### [`edit.deindent`](../edit.ts#L180-L185)
...
### [`edit.deindent.withIncomplete`](../edit.ts#L189-L197)
...
### [`edit.case.toLower`](../edit.ts#L201-L209)
...
### [`edit.case.toUpper`](../edit.ts#L213-L221)
...
### [`edit.case.swap`](../edit.ts#L225-L233)
...
### [`edit.replaceCharacters`](../edit.ts#L248-L260)
...
### [`edit.copyIndentation`](../edit.ts#L361-L374)
...
### [`edit.newLine.above`](../edit.ts#L403-L421)
...
### [`edit.newLine.below`](../edit.ts#L441-L459)
...
### [`edit.surround`](../edit.ts#L574-L581)
...
### [`edit.surroundReplace`](../edit.ts#L594-L603)
...
<a name="keybindings.addCommand" />

### [`keybindings.addCommand`](../keybindings.ts#L44-L47)
...
### [`seek.syntax.experimental`](../seek.ts#L671-L690)
...
<a name="seek.goto.syntax.object" />

### [`seek.goto.syntax.object`](../seek.ts#L767-L775)

Goto next object in direction

<a name="seek.leap" />

### [`seek.leap`](../seek.ts#L811-L827)
...
### [`seek.jumpLabel`](../seek.ts#L1092-L1095)
...
### [`select.buffer`](../select.ts#L20-L25)
...
### [`selections.saveJoined`](../selections.ts#L37-L46)
...
### [`selections.save`](../selections.ts#L57-L71)
...
### [`selections.restore`](../selections.ts#L118-L126)
...
### [`selections.restore.withCurrent`](../selections.ts#L138-L158)
...
### [`selections.pipe`](../selections.ts#L264-L285)
...
### [`selections.filter`](../selections.ts#L313-L334)
